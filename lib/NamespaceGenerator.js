...
class Generator {
    ...
    constructor(modulePath, moduleNode, globalsNamespace, mainNamespace) {
        ...
        if (this.modulePath === Config.mainModule) {
            ...
            this.moduleNamespace.imports.push(('import * as globals from "' + Utilities.relative(modulePath, Config.mainModule.replace(/highcharts$/, 'globals'), true) + '";'));
            ...
            this.moduleNamespace.imports.push(('import * as globals from "' + Utilities.relative(modulePath, Config.mainModule.replace(/highcharts$/, 'globals'), true) + '";'), ('import * as _Highcharts from "' + Utilities.relative(modulePath, Config.mainModule, true) + '";'));
