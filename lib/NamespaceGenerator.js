...
function generate(cliFeedback, modulesDictionary, optionsDeclarations) {
    ...
    Object
        ...
        promises.push(Utils
            ...
            .then(() => cliFeedback('green', 'Generated ' + dtsFilePath)));
        ...
        promises.push(Utils
            ...
            .then(() => cliFeedback('green', 'Generated ' + dtsSourceFilePath)));
    });
    promises.push(Utils
...
class Generator {
    ...
    generateModule(sourceNode, targetDeclaration) {
        ...
        declaration = new TSD.ModuleDeclaration(this._mainNamespace.name, Utils.relative(this.modulePath, Config.mainModule, true));
        if (doclet.isGlobal) {
