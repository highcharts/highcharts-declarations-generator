...
class Generator {
    ...
    generateInterfaceDeclaration(sourceNode) {
        ...
        let doclet = Generator.getNormalizedDoclet(sourceNode), name = Generator.getCamelCaseName(sourceNode.meta.fullname || sourceNode.meta.name || ''), declaration = new TSD.InterfaceDeclaration(name), children = Utils.Dictionary.values(sourceNode.children);
