...
exports.urls = exports.url = exports.uniqueArray = exports.transformLists = exports.save = exports.removeLinks = exports.removeExamples = exports.relative = exports.pluralize = exports.path = exports.parent = exports.log = exports.load = exports.json = exports.isDeepEqual = exports.isCoreType = exports.isBasicType = exports.files = exports.extract = exports.copyAll = exports.copy = exports.clone = exports.capitalize = exports.base = exports.ajax = exports.Dictionary = void 0;
...
function copy(sourceFilePath, targetFilePath) {
    return MkDirP(path_1.posix.dirname(targetFilePath))
...
function save(filePath, fileContent) {
    filePath = path_1.posix.join(CWD, filePath);
    return MkDirP(path_1.posix.dirname(filePath))
