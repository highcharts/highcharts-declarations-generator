...
class NamespaceParser {
    ...
    findNodeInMainModules(nodeName) {
        let found = false, mainModule = this.files[Config.mainModule], node = mainModule, spaceNames = TSD.IDeclaration.namespaces(nodeName, true), indexEnd = (spaceNames.length - 1);
